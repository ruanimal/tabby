/**
 * URL Scheme Handler for Tabby
 *
 * This version avoids calling the shared yargs parser with incomplete arguments,
 * which was causing the application to exit (yargs default behavior on validation failure).
 *
 * Instead, it directly constructs a clean argv object from the URL structure,
 * which is then handled by the renderer-side CLI handlers.
 */
